...
class _SpectrumParent:
    ...
    def plot(self, high=None, **options):
        ...
        if self.full:
            ...
            pyplot.plot(fs, amps, **options)
        else:
            i = None if high is None else find_index(high, self.fs)
            pyplot.plot(self.fs[:i], self.amps[:i], **options)
    ...
    def plot_power(self, high=None, **options):
        ...
        if self.full:
            fs, amps = self.render_full(high)
            pyplot.plot(fs, amps**2, **options)
        else:
            i = None if high is None else find_index(high, self.fs)
            pyplot.plot(self.fs[:i], self.power[:i], **options)
...
class Spectrogram:
    ...
    def plot(self, high=None, **options):
        ...
        pyplot.pcolor(ts, fs, array, **options)
...
class Wave:
    ...
    def plot(self, **options):
        ...
        pyplot.plot(self.ts * xfactor, self.ys, **options)
    ...
    def plot_vlines(self, **options):
        ...
        """
        xfactor = self.get_xfactor(options)
        pyplot.vlines(self.ts * xfactor, 0, self.ys, **options)
